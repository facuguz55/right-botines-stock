  ...
  const handleGuardar = async () => {
    ...
    try {
      await registrar({
        ...
        modeloIdOriginal: modeloOriginal.id,
        talleIdOriginal: talleOriginal.id,
        talleArgOriginal: talleOriginal.talle_arg,
        cantidadActualOriginal: talleOriginal.cantidad,
        cantidad,
        modeloIdNuevo: tipo === 'cambio' ? modeloNuevo!.id : null,
        talleIdNuevo: tipo === 'cambio' ? (talleNuevo?.id ?? null) : null,
        talleArgNuevo: tipo === 'cambio' ? (talleNuevo?.talle_arg ?? null) : null,
        cantidadActualNuevo: tipo === 'cambio' ? (talleNuevo?.cantidad ?? null) : null,

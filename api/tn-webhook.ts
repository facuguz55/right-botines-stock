...
// Duplicada (no importada) en api/cron-resync.ts a propósito: Vercel no
// resuelve en runtime un import entre dos archivos de api/ que son ambos
// rutas propias (confirmado en vivo, "Cannot find module" aunque compila
// bien en local), ni siquiera si el compartido vive en una subcarpeta.
